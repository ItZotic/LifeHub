...
<?php $__env->startSection('title', 'LifeHub - Your Personal Digital Assistant'); ?>
...
<div class="min-h-screen">
    ...
    <header class="bg-white shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                ...
                <a href="<?php echo e(route('register')); ?>" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">Get Started</a>
            </div>
        </div>
    </header>
    ...
    <section class="bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700 text-white py-24 px-4 rounded-3xl mx-4 my-8">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex justify-center space-x-4">
                <a href="<?php echo e(route('register')); ?>" class="bg-white text-blue-600 px-8 py-4 rounded-lg font-semibold hover:bg-blue-50 transition text-lg">Get Started</a>
                <a href="<?php echo e(route('login')); ?>" class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition text-lg">Login</a>
            </div>
    ...
    <section class="bg-gradient-to-br from-blue-600 via-blue-700 to-purple-700 text-white py-16 px-4 rounded-3xl mx-4 my-8">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <a href="<?php echo e(route('register')); ?>" class="inline-block bg-white text-blue-600 px-8 py-4 rounded-lg font-semibold hover:bg-blue-50 transition text-lg">Start Your Journey</a>
        </div>
    </section>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUS\Desktop\WebSys_Final_Project\New folder (2)\resources\views/landing.blade.php ENDPATH**/ ?>
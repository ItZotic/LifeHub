    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
        ...
        <div class="card">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="px-2 py-1 text-xs font-semibold rounded-full {{ $stepsStatus == 'Goal Met!' ? 'bg-green-100 text-green-600 dark:bg-green-900 dark:text-green-400' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400' }}">
                    {{ $stepsStatus }}
                </span>
            </div>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Steps</p>
            <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ number_format($todayMetric->steps) }}</p>
            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mt-3">
                <div class="bg-blue-500 h-2 rounded-full" style="width: {{ $stepsProgress }}%"></div>
            </div>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">Goal: {{ number_format($stepsGoal) }}</p>
        </div>
        ...
        <div class="card">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="px-2 py-1 text-xs font-semibold rounded-full {{ $caloriesStatus == 'Goal Met!' ? 'bg-green-100 text-green-600 dark:bg-green-900 dark:text-green-400' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400' }}">
                    {{ $caloriesStatus }}
                </span>
            </div>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Calories Burned</p>
            <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ number_format($todayMetric->calories) }}</p>
            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mt-3">
                <div class="bg-orange-500 h-2 rounded-full" style="width: {{ $caloriesProgress }}%"></div>
            </div>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">Goal: {{ number_format($caloriesGoal) }}</p>
        </div>
        ...
        <div class="card">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="px-2 py-1 text-xs font-semibold rounded-full {{ $waterStatus == 'Goal Met!' ? 'bg-green-100 text-green-600 dark:bg-green-900 dark:text-green-400' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400' }}">
                    {{ $waterStatus }}
                </span>
            </div>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Water</p>
            <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $todayMetric->water_glasses }}/{{ $waterGoal }}</p>
            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mt-3">
                <div class="bg-cyan-500 h-2 rounded-full" style="width: {{ $waterProgress }}%"></div>
            </div>
        ...
        <div class="card">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="px-2 py-1 text-xs font-semibold rounded-full {{ $sleepStatus == 'Well Rested' ? 'bg-green-100 text-green-600 dark:bg-green-900 dark:text-green-400' : 'bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400' }}">
                    {{ $sleepStatus }}
                </span>
            </div>
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Sleep</p>
            <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $todayMetric->sleep_hours }}h</p>
            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mt-3">
                <div class="bg-purple-500 h-2 rounded-full" style="width: {{ $sleepProgress }}%"></div>
            </div>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">Goal: {{ $sleepGoal }}h</p>
        </div>
        ...
        <div class="card">
            ...
            <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $todayMetric->heart_rate }} <span class="text-base">bpm</span></p>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-3">{{ $heartRateStatus }}</p>
        </div>
    </div>
            ...
            <div class="card mt-8">
                ...
                <div class="grid grid-cols-4 gap-4">
                    <div class="text-center p-4 bg-indigo-100/50 dark:bg-indigo-900/20 rounded-xl">
                        <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $sleepBreakdown['total'] }}h</p>
                    ...
                    <div class="text-center p-4 bg-blue-100/50 dark:bg-blue-900/20 rounded-xl">
                        <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $sleepBreakdown['deep'] }}h</p>
                    ...
                    <div class="text-center p-4 bg-cyan-100/50 dark:bg-cyan-900/20 rounded-xl">
                        <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $sleepBreakdown['light'] }}h</p>
                    ...
                    <div class="text-center p-4 bg-violet-100/50 dark:bg-violet-900/20 rounded-xl">
                        <p class="text-3xl font-bold text-gray-900 dark:text-white">{{ $sleepBreakdown['rem'] }}h</p>
        ...
        <div>
            <div class="card mb-8">
                ...
                <div class="text-center mb-6">
                    <p class="text-6xl font-bold text-gray-900 dark:text-white">{{ $todayMetric->active_minutes }}</p>
                    <p class="text-gray-600 dark:text-gray-400">of 60 minutes</p>
                </div>
                <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                    <div class="bg-yellow-500 h-3 rounded-full" style="width: {{ min(100, ($todayMetric->active_minutes / 60) * 100) }}%"></div>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-green-600 dark:text-green-400 mt-2 flex items-center">
                            ...
                            {{ number_format($stepsRemaining) }} steps to go
                        </p>
                    </div>
                </div>
            </div>
...
<div id="logActivityModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-md w-full mx-4">
        ...
        <form action="{{ route('health.log') }}" method="POST">
            @csrf
            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Steps</label>
                    <input type="number" name="steps" value="{{ $todayMetric->steps }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" min="0">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Calories Burned</label>
                    <input type="number" name="calories" value="{{ $todayMetric->calories }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" min="0">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Water (glasses)</label>
                    <input type="number" name="water_glasses" value="{{ $todayMetric->water_glasses }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" min="0" max="20">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Sleep (hours)</label>
                    <input type="number" name="sleep_hours" value="{{ $todayMetric->sleep_hours }}" step="0.1" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" min="0" max="24">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Heart Rate (bpm)</label>
                    <input type="number" name="heart_rate" value="{{ $todayMetric->heart_rate }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" min="0" max="250">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Active Minutes</label>
                    <input type="number" name="active_minutes" value="{{ $todayMetric->active_minutes }}" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" min="0">
                </div>
            </div>
...
<script>
    ...
    const weeklyMetricsRaw = @json($weeklyMetrics);

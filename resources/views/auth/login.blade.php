    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-gray-50 to-gray-100 p-12 flex-col justify-between">
        <div>
            ...
            <div class="flex items-center space-x-3 mb-12">
                ...
                <span class="text-2xl font-bold text-gray-900">LifeHub</span>
            </div>

            <div class="mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-3">Your personal digital lifestyle dashboard</h2>
            </div>
            ...
            <div class="space-y-6">
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-1">Task Management</h3>
                        <p class="text-gray-600 text-sm">Organize your day with smart task tracking and priorities</p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-1">Habit Tracking</h3>
                        <p class="text-gray-600 text-sm">Build lasting habits with streak tracking and motivation</p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-1">Expense Insights</h3>
                        <p class="text-gray-600 text-sm">Track spending and visualize your financial health</p>
                    </div>
                </div>
                ...
                <div class="flex items-start space-x-4">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-1">Health Monitoring</h3>
                        <p class="text-gray-600 text-sm">Track your wellness journey with detailed health metrics</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        ...
                        <button type="button" onclick="togglePassword()" class="absolute inset-y-0 right-0 pr-3 flex items-center hover:text-gray-600">
                            <svg id="eye-icon-open" class="h-5 w-5 text-gray-400 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                            </svg>
                            <svg id="eye-icon-closed" class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
